...
import { DomainsType, PageProps, TrackerType, User } from "@/types";
...
export default function Index({ auth }: PageProps) {
    const [url, setUrl] = useState(`/dashboard/fetch/trackers`);
    ...
    return (
        <Authenticated user={auth.user}>
            <Head title="Trackers">
                <meta
                    name="description"
                    content=" Manage and track your trackers in one convenient
                        location."
                />
            </Head>
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-gray-500 hidden sm:block">
                        Manage and track your trackers in one convenient
                        location.
                    </p>
                </div>
                <DateRangePicker
